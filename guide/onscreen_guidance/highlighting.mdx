...
Onscreen guidance combines conversational logic with onscreen indications.
...
When showing things onscreen, you generally want the chat widget to be closed and the message attached to the higlighted element.
