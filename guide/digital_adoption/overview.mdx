---
name: Overview
route: /docs/digital-adoption
menu: Digital adoption
meta:
  - name: description
...
By integrating the Botfront Assistant chat widget in your website or web application, you can provide users (customers or employees) an unprecedented level of automated assistance with contextual onscreen instructions.
