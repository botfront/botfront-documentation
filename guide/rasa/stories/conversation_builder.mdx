...
Botfront integrates Rasa, a powerful and popular open source conversational AI framework.

Those capabilities are privided by a deep integration with [Rasa](https://github.com/rasaHQ/rasa), an open source library featuring the most advanced open source conversational AI technology.
...
Let's start with a simple example, greetings:
...
## Using responses types with buttons
...
We'll address remembering facts in the slots section. Here, let's discuss remembering previous turns.
