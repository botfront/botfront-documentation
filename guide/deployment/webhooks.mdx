...
If set, and you project has environements, the deploy menu will be available under nex to the training button

#### Request

Botfront will send a request to the api with the following informations
