...
| `GRAPHQL_REQUEST_SIZE_LIMIT` | The size over which requests sent to the GraphQL server will receive a HTTP Error 413 (Payload Too Large) response. [Defaults to 100kb.](https://github.com/expressjs/body-parser#limit) | `botfront` (optional)
